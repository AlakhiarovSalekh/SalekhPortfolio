...
export function ProjectCard({project,locale}:{project:Project;locale:Locale}){
  ...
  return <article className="project-card">
    <div className="project-visual" aria-hidden="true"><div className="visual-orb"/><span>{project.category.replace("-"," ")}</span></div>
    <div className="project-card-body">
      ...
      <div className="chips">{project.technologies.slice(0,5).map((t)=><span key={t}>{t}</span>)}</div>
